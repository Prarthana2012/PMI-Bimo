CREATE OR REPLACE PROCEDURE {DB_NAME}.PMI_AGENT.LOAD_STAGING_LAYER("P_STORY_KEY" VARCHAR, "P_TARGET_DB" VARCHAR DEFAULT 'D_IN_CAPG_BIONIC_PMI_POC', "P_SOURCE_DB" VARCHAR DEFAULT 'D_IN_CAPG_BIONIC_PMI_POC')
RETURNS VARCHAR
LANGUAGE PYTHON
